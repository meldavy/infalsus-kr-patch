...
## 패치 배포 및 다운로드
https://github.com/meldavy/infalsus-kr-patch/releases

## 오번역 제보
https://github.com/meldavy/infalsus-kr-patch/issues/new

혹은 깃허브 사용법에 능숙 하시다면 Pull Request 신청 주세요

## 번역 작업 이력 (모델 크레딧)

- **1~63화, 86화 이후**: DeepSeek V4.1 Flash가 번역과 교정을 모두 담당했습니다.
- **64~85화**: Opus 5가 별도의 교정 단계 없이 직접 번역했습니다.
- 패치 제작자로서 직접 플레이해가며 실시간으로 Claude Sonnet 과 함께 수동 검수를 진행하고 있습니다.
